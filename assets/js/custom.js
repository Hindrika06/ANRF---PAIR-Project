...
//  Event title shorting
    ...
    // One-time entrance animation: add .anrf-play on first visit only
    (function () {
        var stage = document.getElementById('anrfLogoStage');
        if (!stage) return;
        if (sessionStorage.getItem('anrf_intro_done')) return;
        sessionStorage.setItem('anrf_intro_done', '1');
        stage.classList.add('anrf-play');
    }());
