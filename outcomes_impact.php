                ...
                <div class="col-md-7 col-sm-7">
                    <div class="course-info">
                        ...
                        <div class="overview-content" style="margin-top: 20px;">       
                            <!-- Expected Outcomes -->
                            <h2 style="margin-top: 30px; color:#bc2121; ">Expected Outcomes</h3>
                            <ul class="font-color-grey-medium" style="font-size: 15px;">
                                <li>High-impact publications</li>
                                <li>Novel biomarkers and therapeutic targets</li>
                                <li>Patents</li>
                                <li>AI-driven research tools</li>
                                <li>Skilled manpower development</li>
                            </ul>

                            <!-- Societal Impact -->
                            <h2 style="margin-top: 30px; color:#bc2121; ">Societal Impact</h3>
                            <p class="font-color-grey-medium" style="font-size: 20px;">
                                The project aims to:
                            </p>

                            <ul class="font-color-grey-medium" style="font-size: 15px;">
                                <li>Improve healthcare research</li>
                                <li>Support early disease detection</li>
                                <li>Contribute to national research priorities</li>
                            </ul>
